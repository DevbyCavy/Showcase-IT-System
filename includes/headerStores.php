    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarMenu">
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="storesDashboard.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="store.php"><i class="fas fa-circle-plus"></i> Store</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="brand.php"><i class="fas fa-building"></i> Brand</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="categories.php"><i class="fas fa-boxes"></i> Category</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="IssueProductReport.php?o=add"><i class="fas fa-list"></i> Products Report</a></li>
                    </ul>
                </li>
