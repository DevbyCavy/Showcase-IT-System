...
<div class="container-fluid px-4 mt-3">
    ...
    <div class="row g-4">
        ...
        <!-- ── LEFT: Form ── -->
        <div class="col-lg-5">
            <div class="card shadow-sm h-100" style="border-top: 4px solid #ff7b00;">
                <div class="card-header d-flex align-items-center gap-2"
                     style="background:#ff7b00; color:#fff;">
                    <i class="fas fa-file-signature"></i>
                    <span class="fw-bold">New Requisition</span>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="">
                        ...
                        <button type="submit" name="submit_requisition"
        ...
        <div class="col-lg-7">
            <div class="card shadow-sm" style="border-top: 4px solid #ff7b00;">
                <div class="card-header d-flex align-items-center justify-content-between"
                     style="background:#ff7b00; color:#fff;">
                    <span><i class="fas fa-list me-2"></i><span class="fw-bold">Submitted Requisitions</span></span>
                    <!-- Search -->
